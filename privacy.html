  ...
  <body>
    ...
    <main class="container-sm">
      <article class="article">
        ...
        <p class="article__paragraph">Last updated: February 12, 2022</p>
      ...
      <article class="article">
        <h1 class="article__title">Interpretation and Definitions</h1>
        <section class="article__section">
          <h2 class="article__heading">Interpretation</h2>
          <p class="article__paragraph">
        ...
        <section class="article__section">
          <h2 class="article__heading">Definitions</h2>
          <p class="article__paragraph">
          ...
          <ul class="article__list">
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to aranoz.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to aranoz, accessible from
                <a
                  href="http://127.0.0.1:5500"
                  rel="external nofollow noopener"
                  target="_blank"
                  >http://127.0.0.1:5500</a
                >
              </p>
            </li>
            <li>
      ...
      <article class="article">
        <h1 class="article__title">Collecting and Using Your Personal Data</h1>
        <section class="article__section">
          <h2 class="article__heading">Types of Data Collected</h2>
          <section class="article__section">
            <h3 class="article__heading">Personal Data</h3>
            <p class="article__paragraph">
          ...
          <section class="artcile__section">
            <h3 class="article__heading">Usage Data</h3>
            <p class="article__paragraph">
        ...
        <section class="article__section">
          <h2 class="article__heading">Use of Your Personal Data</h2>
          <p class="article__paragraph">
        ...
        <section class="article__section">
          <h2 class="article__heading">Retention of Your Personal Data</h2>
          <p class="article__paragraph">
        ...
        <section class="article__section">
          <h2 class="article__heading">Transfer of Your Personal Data</h2>
          <p class="article__paragraph">
        ...
        <section class="article__section">
          <h2 class="article__heading">Disclosure of Your Personal Data</h2>
          <section class="article__section">
            <h3 class="article__heading">Business Transactions</h3>
            <p class="article__paragraph">
          ...
          <section class="article__section">
            <h3 class="article__heading">Law enforcement</h3>
            <p class="article__paragraph">
          ...
          <section class="article__section">
            <h3 class="article__heading">Other legal requirements</h3>
            <p class="article__paragraph">
        ...
        <section class="article__section">
          <h2 class="article__heading">Security of Your Personal Data</h2>
          <p class="article__paragraph">
      ...
      <article class="article">
        <h1 class="article__title">Children's Privacy</h1>
        <p class="article__paragraph">
      ...
      <article class="article">
        <h1 class="article__title">Links to Other Websites</h1>
        <p class="article__paragraph">
      ...
      <article class="article">
        <h1 class="article__title">Changes to this Privacy Policy</h1>
        <p class="article__paragraph">
          ...
          <li>
            <p>
              ...
              <a
                ...
                rel="external nofollow noopener"
                target="_blank"
                >http://127.0.0.1:5500/contact.html</a
              >
            </p>
          </li>
          <li>
