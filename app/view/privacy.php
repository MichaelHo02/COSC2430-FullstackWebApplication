<div class="container mt-5">
    <div class="row justify-content-center">
        ...
        <section class="col-sm-10 mt-4">
            ...
            <div class="mt-5">
                <h2 class="display-5 col-12">Definitions</h2>
                <p class="mt-4">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            "We", "Us" or "Our" in this Agreement) refers to InstaKilogram.
                        </p>
                    </li>
                    <li>
                        <p>
        ...
        <section class="col-sm-10 mt-4">
            ...
            <div class="mt-5">
                ...
                <div class="mt-5">
                    <h3 class="display-6">Personal Data</h3>
                    <p class="mt-4">
                ...
                <div class="mt-5">
                    <h3 class="display-6">Usage Data</h3>
                    <p class="mt-4">
                ...
                <div class="mt-5" id="cookies">
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                ...
                                popularity of a certain div and verifying system and server
                                integrity).
                            </p>
                        </li>
                    </ul>
                    ...
                    <p class="mt-4">
                        ...
                        div of our Privacy Policy.
                    </p>
                </div>
            </div>
            <div class="mt-5">
                <h2 class="display-5 col-12">Use of Your Personal Data</h2>
                <p class="mt-4">
            ...
            <div class="mt-5">
                <h2 class="display-5 col-12">Retention of Your Personal Data</h2>
                <p class="mt-4">
            ...
            <div class="mt-5">
                <h2 class="display-5 col-12">Transfer of Your Personal Data</h2>
                <p class="mt-4">
            ...
            <div class="mt-5">
                <h2 class="display-5 col-12">Disclosure of Your Personal Data</h2>
                <div class="mt-5">
                    <h3 class="display-6">Business Transactions</h3>
                    <p class="mt-4">
                ...
                <div class="mt-5">
                    <h3 class="display-6">Law enforcement</h3>
                    <p class="mt-4">
                ...
                <div class="mt-5">
                    <h3 class="display-6">Other legal requirements</h3>
                    <p class="mt-4">
            ...
            <div class="mt-5">
                <h2 class="display-5 col-12">Security of Your Personal Data</h2>
                <p class="mt-4">
        ...
        <section class="col-sm-10 mt-4">
            ...
            <div class="d-flex justify-content-center gap-3">
                <a class="btn btn-outline-secondary" href="mailto:admin@gmail.com">
                    <i class="bi bi-envelope-fill"></i>
                </a>

                <a class="btn btn-outline-secondary" href="tel:+840923534">
